        ...
        <ul class="top-header">
            <li>
                <a href="../index.php" class="acai-icon">
                    <img src="https://res.cloudinary.com/dw2eqq9kk/image/upload/v1755358113/acai-icon_jsrexi_t30xv5.png"
                        alt="Açaí Logo image" class="item-translate">
                </a>
            </li>
    ...
    <main>
        ...
        <div class="main-title">
            <div>
                ...
                <p>Visualizar e alterar Administradores</p>
            </div>
        ...
        <ul class="main-center">
            ...
            <li class="input-search">
                <form method="get">
                    <label for="iadminName">Pesquisar Administradores pelo Nome ou Email</label>
        ...
        <div class="main-bottom">
            <?php 
                if(isset($_GET["searchQuery"])){
                    echo "<h1>Administradores Encontrados com o Filtro <strong>\"{$_GET["searchQuery"]}\"</strong></h1>";
                }else{
                    echo "<h1>Todos os <strong>Administradores</strong></h1>";
                }
            ?>
            <div style="overflow: auto; height:45vh">
                <table class="main-table">
                    ...
                    <tbody>
                        <?php 
                            if(isset($_GET["searchQuery"])){
                                searchColumns($_GET["searchQuery"], "admin");

                            }else{
                                GetTableMannager("admin");
                            }
                        ?>
                    </tbody>
                </table>
