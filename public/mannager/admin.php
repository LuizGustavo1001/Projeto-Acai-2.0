...
<body>
    ...
    <header>
        ...
        <a href="../account/logout.php"><button class="center-button">Sair</button></a>
    </header>
    ...
    <main>
        ...
        <ul class="main-center">
            <li class="item-amount">
                <p class="amountItem"><strong> <?php echo $_SESSION["admin"]?> </strong></p>
                <p>Administradores Cadastrados</p>
            </li>

            <li class="input-search">
                <form method="get">
                    <label for="iadminName">Pesquisar Administradores pelo Nome</label>
