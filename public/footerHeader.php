    ...
    if(isset($_SESSION["idOrder"])){
        ...
        if($getCartAmount->execute()){
            ...
            if ($result) {
                ...
                return "<p class=\"numberItems\">{$cartAmount}</p>";
            } else {
                return "<p class=\"numberItems\">0</p>";
            }
        }else{
    ...
    echo "
        <header>
            <div class='left-header'>
                <a href='{$indexPageLink}' class='translate-alt'>
                ...
                <p><span>Açaí e Polpas Amazônia</span></p>
            </div>

            <nav>
                <ul>
                    <li>
                        <a href='{$userPageLink}'> <!--match-->
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href='https://github.com/LuizGustavo1001'>LuizGustavo1001</a>
                    </li>
                </ul>
                <ul>
                    <li>
