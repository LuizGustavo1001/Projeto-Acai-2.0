                ...
                <div class="forms-text">
                    <div class="forms-item product-size">
                        ...
                        <select name="size" id="isize" class="product-size-selector">
                            ...
                            <option value="saborazziAvelaP">Creme de Avelã Premium</option>
                            <option value="saborazziAvelaT">Creme de Avelã Tradicional</option>
                            <option value="saborazziLeitinho">Leitinho</option>
                            <option value="saborazziPacoca">Paçoca Cremosa</option>
                            <option value="saborazziSkimoL">Skimo ao Leite</option>
                            <option value="saborazziSkimoB">Skimo Branco</option>
                            <option value="saborazziWafer">Wafer Cremoso</option>
                        </select>
                    </div>
