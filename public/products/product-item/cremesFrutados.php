...
<head>
    ...
    <?php
        ...
        $price1 = returnPrice('cremeCupuacu10');
        $price2 = returnPrice('cremeMaracuja10');
        $price3 = returnPrice('cremeMorango10');
        $price4 = returnPrice('cremeNinho10');
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const prices = {
                cremeCupuacu10:     "<?= $price1; ?>",
                cremeMaracuja10:    "<?= $price2; ?>",
                cremeMorango10:     "<?= $price3; ?>",
                cremeNinho10:       "<?= $price4; ?>",
            };
                ...
                <div class="forms-text">
                    <div class="forms-item product-size">
                        ...
                        <select name="size" id="isize" class="product-size-selector">
                            <option value="cremeMorango10">Morango</option>
                            <option value="cremeMaracuja10">Maracujá</option>
                            <option value="cremeCupuacu10">Cupuaçu</option>
                            <option value="cremeNinho10">Ninho</option>
                        </select>
                    </div>
