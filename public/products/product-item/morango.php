        ...
        <section class="product-hero">
            <div class="product-main">
                <div class="product-main-img">
                    <img src="https://res.cloudinary.com/dw2eqq9kk/image/upload/v1750080166/strawberry_akhbkp.jpg" alt="Product Image">
                </div>

                <div class="product-main-text">
                    <h1>Morango Congelado - 1kg</h1>
                ...
                <div class="forms-text">
                    <div class="forms-item product-size">
                        ...
                        <select name="size" id="isize" class="product-size-selector">
                            <option value="morango1">1kg</option>
                        </select>
                    </div>
