...
function displayHeader($page = "index"){
            ...
            <aside class='regular'>
                <nav class='aside-hero'>";
                    foreach($menu as $key => $item){
                        ...
                        echo "
                            <a href='{$item['link']}' class='nav-link {$class}'>
                                {$amountCart}
                                <div class='icon-bg'>{$item['icon']}</div>
    ...
    echo "      
                ...
                <div class='toggle-theme regular mobile'>
            ...
            <div class='toggle-theme regular desktop'>
                <div class='selected-bg'></div>
...
function displayFooter(){
    ...
    echo "
        <footer>
            ...
            foreach($map as $item){
                echo "
                    <a href='{$item['link']}' target='_blank' class='icon-wrapper hover'>
