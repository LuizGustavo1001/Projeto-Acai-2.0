...
if(isset($_POST['password'], $_POST['newPassword'])){
    ...
    try{
        ...
        $mailService->send(
            $_SESSION["mailUser"],
            'Senha alterada em Açaí e Polpas Amazônia',
            '
                <!DOCTYPE html>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="pad">
                                                                                                                <div style="color:#583f48;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:17px;">
                                                                                                                    ...
                                                                                                                    <p style="margin: 0;">Você acabou de alterar sua <strong>senha</strong>&nbsp;no site <strong>Açaí e Polpas Amazônia.</strong></p>
                                                                                                                </div>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </table>
