...
INSERT INTO `admin_data` VALUES (1,'https://res.cloudinary.com/dw2eqq9kk/image/upload/v1758992688/Users-Pictures/adminPic001.jpg');
...
INSERT INTO `client_data` VALUES (2),(7);
...
CREATE TABLE `order_data` (
  ...
  `orderStatus` enum('Pendente','Finalizado') NOT NULL DEFAULT 'Pendente',
  PRIMARY KEY (`idOrder`),
...
INSERT INTO `order_data` VALUES (25,2,'2025-10-03','14:20:06','Pendente');
...
INSERT INTO `product_data` VALUES (1,'Caixa de Açaí','CaixaAcai','Açaí e Polpas Amazônia','Creme'),(2,'Colheres p/ Açaí e Sorvete','colheres','Plastjet','Outro'),(3,'Cremes Frutados','cremesFrutados','Energia Natural','Creme'),(4,'Açaí Zero','acaiZero','Outra Marca','Creme'),(5,'Açaí c/Ninho','acaiNinho','Outra Marca','Creme'),(6,'Morango Congelado','morango','Outra Marca','Outro'),(7,'Leite em Pó','leiteEmPo','Outra Marca','Adicional'),(8,'Granola Tia Sônia','granolaTiaSonia','Tia Sônia','Adicional'),(9,'Granola Tradicional','granolaTradicional','Outra Marca','Adicional'),(10,'Caixa de Paçoca','caixaPacoca','Unidoces','Adicional'),(11,'Farofa de Paçoca','farofaPacoca','Balsamo','Adicional'),(12,'Amendoim Triturado','amendoimTriturado','Balsamo','Adicional'),(13,'Ovomaltine','ovomaltine','Ovomaltine','Adicional'),(14,'Gotas de Chocolate','gotasChocolate','Harald','Adicional'),(15,'Chocoball','chocoball','VaBene','Adicional'),(16,'Jujuba','jujuba','SimoGomas','Adicional'),(17,'Confetes Coloridos','confetesColoridos','Coloreti','Adicional'),(18,'Cremes Saborazzi','cremesSaborazzi','Saborazzi','Creme'),(19,'Polpas de Frutas','polpas','Sabor Natural','Outro');
...
INSERT INTO `user_data` VALUES (1,'Farofilson Bananilson','admin@dominio.com','(32) 9 7854 0244','$2y$10$sQhi2JujYSx8Xaa7e74GvOeBvl9PFbfaBTfrqYNGWvp4ystxqszhC','Cidade Legal','Bairro Legal','Rua Legal','993','','RJ'),(2,'Cliente 23131321','client@dominio.com','(33) 9 7543 5772','$2y$10$sQhi2JujYSx8Xaa7e74GvOeBvl9PFbfaBTfrqYNGWvp4ystxqszhC','Cidade asbdajda','Bairro','Rua','81','','RN'),(7,'Teste 11321','teste@dominio.com','(32) 9 7533 9031','$2y$10$Z4EKxm3gCVvnyz3BdReqyeIwKekqpHYyXtwCbTvJxj0r04be8c71C','Cidade Tropilson','Bairro Top','rua Legal','31','Ponto de Referência','ES');
...
-- Dump completed on 2025-10-03 16:23:06
