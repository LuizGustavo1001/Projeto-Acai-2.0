...
CREATE TABLE `admin_data` (
  ...
  PRIMARY KEY (`idAdmin`),
  CONSTRAINT `admin_data_ibfk_1` FOREIGN KEY (`idAdmin`) REFERENCES `user_data` (`idUser`)
...
INSERT INTO `admin_data` VALUES (1,'https://res.cloudinary.com/dw2eqq9kk/image/upload/v1758731904/Users-Pictures/adminPic001.jpg'),(5,'https://res.cloudinary.com/dw2eqq9kk/image/upload/v1758729927/Users-Pictures/adminPic005.jpg');
...
CREATE TABLE `client_data` (
  ...
  CONSTRAINT `client_data_ibfk_1` FOREIGN KEY (`idClient`) REFERENCES `user_data` (`idUser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `client_data` VALUES (2),(4);
...
INSERT INTO `order_data` VALUES (11,2,'2025-09-25','14:14:48','Pending'),(12,2,'2025-09-25','14:24:16','Pending');
...
CREATE TABLE `product_order` (
  ...
  CONSTRAINT `product_order_ibfk_2` FOREIGN KEY (`idProduct`) REFERENCES `product_version` (`idProduct`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product_order` VALUES (12,7,1,80.00,NULL);
...
INSERT INTO `user_data` VALUES (1,'Admin 2000','admin@dominio.com','(32) 9 7854 0244','$2y$10$sQhi2JujYSx8Xaa7e74GvOeBvl9PFbfaBTfrqYNGWvp4ystxqszhC','Cidade Legal','Bairro Legal','Rua Legal','993','','AC'),(2,'Cliente 1','client@dominio.com','(33) 9 7543 5772','$2y$10$sQhi2JujYSx8Xaa7e74GvOeBvl9PFbfaBTfrqYNGWvp4ystxqszhC','Cidade','Bairro','Rua','81','','PR'),(4,'Farofilson Bananilson','farofilson@dominio.com','(33) 9 7564 1342','$2y$10$tdGyLGVd9F8vzG3IaPtFeuxpQad6JMxeIXB1od1n.YRlgdVR0TWTO','Cachoeira Nova','Cidade Nova','R. Laranjeiras','22','','AC'),(5,'Teste Admin','teste@dominio.com','(43) 9 5255 8742','$2y$10$51anleBQRXjbCTZoY2Ui3uuZbfmY3/SDduWqmiliWRJJWJYqxlUz2','Cidade','Bairro','Rua','901','','AC');
...
-- Dump completed on 2025-09-25 15:38:35
